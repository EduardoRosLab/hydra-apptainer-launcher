...
class SlurmQueueConf(BaseQueueConf):
    ...
    _target_: str = (
        "hydra_plugins.hydra_apptainer_launcher.submitit_launcher.CustomSlurmLauncher"
    )
...
class LocalQueueConf(BaseQueueConf):
    _target_: str = (
        "hydra_plugins.hydra_apptainer_launcher.submitit_launcher.CustomLocalLauncher"
    )
